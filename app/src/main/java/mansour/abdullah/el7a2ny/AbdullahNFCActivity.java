...
public class AbdullahNFCActivity extends AppCompatActivity
{
    ...
    TextView message;
    Button btnWrite,read_btn;

    @Override
    protected void onCreate(Bundle savedInstanceState)
    {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_abdullah_nfc);

        context = AbdullahNFCActivity.this;
