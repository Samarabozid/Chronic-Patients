package android.android.chronicpatients.AdminApp.AdminFragments;
...
import android.android.chronicpatients.AdminApp.AdminDoctorsAndParamedicsDetailsActivity;
...
public class DoctorsFragment extends Fragment
{
    ...
    private void toggleSectionText(View view)
    {
        ...
        if (show)
        {
            expand(lyt_expand_text, new android.android.chronicpatients.ActivitiesAndFragments.DoctorsFragment.AnimListener()
            {
                @Override
    ...
    public static void expand(final View v, final android.android.chronicpatients.ActivitiesAndFragments.DoctorsFragment.AnimListener animListener)
    {
