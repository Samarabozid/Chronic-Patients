...
import android.android.chronicpatients.DoctorApp.ViewPatientPhotosActivity;
...
public class PatientsFragment extends Fragment
{
    ...
    private void DisplayallDoctors()
    {
        ...
        {
            @Override
            protected void onBindViewHolder(@NonNull final PatientsViewHolder holder, int position, @NonNull final PatientModel model)
            {
                rotateLoading.stop();

                final String key = getRef(position).getKey();

                final String patientID = model.getPatient_user_id();
                ...
                holder.view_photo.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        Intent i = new Intent(getActivity(), ViewPatientPhotosActivity.class);
                        i.putExtra("patientID",key);
                        startActivity(i);
                    }
                });
            }
            ...
            {
                View view = LayoutInflater.from(getContext()).inflate(R.layout.patient_item, parent, false);
    ...
    {
        ImageView doctor_mobile,view_photo;
        ...
        PatientsViewHolder(View itemView)
        {
            ...
            view_photo = itemView.findViewById(R.id.view_photo);
        }
