...
public class PatientDetailsActivity extends AppCompatActivity
{
    ...
    ImageView profilepicture,callmobile,datepick,viewPhoto;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        databaseReference.child("Photos").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if(dataSnapshot.exists()){
                    if(dataSnapshot.hasChild(PATIENT_KEY)){
        ...
        viewPhoto.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(getApplicationContext(), ViewPatientPhotosActivity.class);
