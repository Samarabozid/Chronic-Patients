...
import android.android.chronicpatients.GuestApp.GuestActivity;
import android.android.chronicpatients.Models.ParamedicModel;
...
import android.android.chronicpatients.Models.DoctorModel;
...
public class SignupFragment extends Fragment
{
    ...
    private void CreatePatientAccount(final String fullname, final String email, String password, final String personalid, final String nfcid, final String birthdate, final String closemobile, final String mobile, final int bloodtype, final String address, final String imageurl)
    {
        auth.createUserWithEmailAndPassword(email,password)
                .addOnCompleteListener(new OnCompleteListener<AuthResult>()
                {
