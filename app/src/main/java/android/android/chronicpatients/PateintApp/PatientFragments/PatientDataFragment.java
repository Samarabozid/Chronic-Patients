...
import android.android.chronicpatients.Models.PatientModel;
import android.android.chronicpatients.R;
import android.android.chronicpatients.ActivitiesAndFragments.RegisterActivity;
...
public class PatientDataFragment extends Fragment
{
    ...
    Button edit_profile_btn,signout_btn,savechanges_btn,uploadPhotos_btn;
    private static final int GALLERY_REQUEST = 1;
    private Uri mImageUri1 = null;

    ImageView profilepicture,datepick,remover_user,upload_photos;
    ...
    {
        view = inflater.inflate(R.layout.patient_data_fragment, container, false);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState)
    {
        ...
        upload_photos = view.findViewById(R.id.upload_photos);
        uploadPhotos_btn = view.findViewById(R.id.upload_btn);
        ...
        uploadPhotos_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ...
                progressDialog.setMessage("Please Wait Until upload photo ...");
        ...
        profilepicture.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                CropImage.activity()
                        ...
                        .setAspectRatio(1,1)
                        .start(getContext(), PatientDataFragment.this);
            }
        });
    ...
    private void uploadPhotos() {
        ...
        Task<Uri> urlTask = uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
            ...
            public void onComplete(@NonNull Task<Uri> task) {
                ...
                String id = databaseReference.child("Photos").child(getUid()).push().getKey();
                PhotoModel photoModel = new PhotoModel(id,imageurl1,"",0);
                databaseReference.child("Photos").child(getUid()).child(id).setValue(photoModel);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data)
    {
        ...
        if (requestCode == GALLERY_REQUEST && resultCode == RESULT_OK) {
            ...
            upload_photos.setImageURI(mImageUri1);
        }
